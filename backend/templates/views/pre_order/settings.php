...
<div id="wceazy_pre_order">
    ...
    <div class="wceazy_pre_order_page_title">
        <div class="page_title_part_left">
            <h2><?php esc_html_e('Pre Order', 'wceazy'); ?></h2>
            <a target="_blank"
    ...
    <div class="wceazy_pre_order_container">
        ...
        <div class="wceazy_pre_order_tab">
            ...
            <div class="wceazy_pre_order_tab_part_right">
                ...
                <div class="coupon_tab_body" data-id="tab_general">
                    ...
                    <div class="tab_body_form"> 
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_enable_pre_order">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Enable Pre Order', 'wceazy'); ?></label>
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_display_desktop">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Display in Desktop', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch"><input type="checkbox"
                                        <?php echo esc_attr($wceazy_sb_display_desktop == "yes" ? "checked" : ""); ?>><span
                                        class="slider round"></span></label>
                                <small><?php esc_html_e('Switch ON to display Pre Order on Desktop.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_display_mobile">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Display in Mobile', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch"><input type="checkbox"
                ...
                <div class="coupon_tab_body" data-id="tab_text">
                    <div class="tab_body_title">
                        <h1><?php esc_html_e('Text & Labels Page Settings', 'wceazy'); ?></h1>
                    </div>
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_show_in_cart">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Cart Total', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch"><input type="checkbox"
                                        <?php echo esc_attr($wceazy_sb_show_in_cart == "yes" ? "checked" : ""); ?>><span
                                        class="slider round"></span></label>
                                <small><?php esc_html_e('Turn on the switch to show the free Pre_Order message in the shopping cart.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_position_cart_subtotal">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Choose spot on cart page.', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_pre_order_select_field">
                                    ...
                                    <option value="woocommerce_cart_totals_before_Pre_Order"
                                        ...
                                        <?php esc_html_e('Before Pre_Order block', 'wceazy'); ?></option>
                                    <option value="woocommerce_cart_totals_after_Pre_Order"
                                        ...
                                        <?php esc_html_e('After Pre_Order block', 'wceazy'); ?></option>
                                </select>
                                <small><?php esc_html_e('Select position of the free Pre_Order notification in cart page.', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_show_in_checkout">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Display in Total Cost Area', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch"><input type="checkbox"
                                        <?php echo esc_attr($wceazy_sb_show_in_checkout == "yes" ? "checked" : ""); ?>><span
                                        class="slider round"></span></label>
                                <small><?php esc_html_e('Turn ON the switch to show the free Pre_Order notification in checkout subtotal area.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_position_checkout_subtotal">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Select Position on Checkout Page', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_pre_order_select_field">
                                    <option value=""><?php esc_html_e('Please select', 'wceazy'); ?></option>
                                ...
                                <small><?php esc_html_e('Select position where the free Pre_Order notification will be displayed on checkout page.', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_Pre_Order_headline">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Headline Text', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_pre_order_text_field" type="text" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_pre_order_headline); ?>">
                                <small><?php esc_html_e('Enter cart & checkout page free Pre_Order progress bar headline text.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_Pre_Order_progress_bar_bg">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Progress Bar\'s Background', 'wceazy'); ?>
                            ...
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label
                                        for="wceazy_Pre_Order_progress_bar_bg"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_Pre_Order_progress_color">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Progress Bar\'s Color', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label
                                        for="wceazy_Pre_Order_progress_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                                <small><?php esc_html_e('Set your free Pre Order\'s progress color.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_Pre_Order_progress_text_color">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Progress Bar\'s Text Color', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label
                                        for="wceazy_Pre_Order_progress_text_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                                <small><?php esc_html_e('Set your free Pre Order\'s progress text color.', 'wceazy'); ?></small>
                            </div>
                        </div>
                    </div>
                </div> 
                ...
                <div class="coupon_tab_body" data-id="tab_messages">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_zero_order_amount_msg">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Message on Zero Order Amount', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <textarea disabled class="wceazy_pre_order_textarea_field"
                                    rows="3"><?php echo esc_attr($wceazy_sb_zero_order_amount_msg); ?></textarea>
                                <small><?php esc_html_e('"Empty Cart in Pre_Order Zone: Add items to qualify for Free Pre_Order ({minimum_order})."', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_partial_order_amount_msg">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Message on Partially Completed Order Amount', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <textarea disabled class="wceazy_pre_order_textarea_field"
                                    rows="3"><?php echo esc_attr($wceazy_sb_partial_order_amount_msg); ?></textarea>
                                <small><?php esc_html_e('Pre_Order Alert: Add {missing_amount} for Free Pre_Order (Min. order: {minimum_order}, Current total: {cart_total}).', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_completed_order_amount_msg">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Message on Completed Order Amount', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <textarea disabled class="wceazy_pre_order_textarea_field"
                ...
                <div class="coupon_tab_body" data-id="tab_effect">
                    <div class="tab_body_title">
                        <h1><?php esc_html_e('Notifications Settings', 'wceazy'); ?></h1>
                    </div>
                    <div class="tab_body_form">
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_initial_delay">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Initial Delay Time', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <input disabled class="wceazy_pre_order_text_field" type="number" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_initial_delay); ?>">
                                <small><?php esc_html_e('Set the time delay for Free Pre Order to decide when it appears in milliseconds.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_allow_disappear_time">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Allow Disappear Time', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_disappear_time">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Set Disappear Time', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <input disabled class="wceazy_pre_order_text_field" type="number" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_disappear_time); ?>">
                                <small><?php esc_html_e('Set disappear time in milliseconds. The Free Pre Order will disappear according to your setting time.', 'wceazy'); ?></small>
                            </div>
                        </div>
                    </div>
                </div> 
                ...
                <div class="coupon_tab_body" data-id="tab_style">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_position">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Pre Order Position', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_pre_order_select_field">
                                    <option value=""><?php esc_html_e('Please select', 'wceazy'); ?></option>
                                    <option value="top"
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_layout">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Pre Order Layout', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_pre_order_select_field"
                                    ...
                                    <option value="1"
                                        ...
                                        <?php esc_html_e('Layout 1', 'wceazy'); ?></option>
                                    <option value="2"
                                        <?php echo esc_attr("2" == $wceazy_sb_layout ? "selected" : ""); ?>>
                                        <?php esc_html_e('Layout 2', 'wceazy'); ?></option>
                                </select>
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_bg">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Background Color', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label
                                        for="wceazy_pre_order_bg"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                                <small><?php esc_html_e('Set your free Pre Order background color.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_padding_top">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Padding Top', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_pre_order_text_field" type="number" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_padding_top); ?>">
                                <small><?php esc_html_e('Set your free Pre Order\'s top padding.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_padding_bottom">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Padding Bottom', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_pre_order_text_field" type="number" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_padding_bottom); ?>">
                                <small><?php esc_html_e('Set your free Pre Order\'s bottom padding.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_padding_left_right">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Padding Left-Right', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_pre_order_text_field" type="number" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_padding_left_right); ?>">
                                <small><?php esc_html_e('Set your free Pre Order\'s left and right padding.', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_msg_text_color">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Text Color of Message', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label
                                        for="wceazy_pre_order_msg_text_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                                <small><?php esc_html_e('Set your free Pre Order\'s message text color.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_msg_link_text_color">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Link Color on Message', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label
                                        for="wceazy_pre_order_msg_link_text_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                                <small><?php esc_html_e('Set your free Pre Order\'s message link text color.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_msg_font_size">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Font Size of Message', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_pre_order_text_field" type="number" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_msg_font_size); ?>">
                                <small><?php esc_html_e('Set your free Pre Order\'s message font size.', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_msg_text_align">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Text Align of Message', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_pre_order_select_field">
                                    <option value=""><?php esc_html_e('Please select', 'wceazy'); ?></option>
                                    <option value="left"
                                    ...
                                    <option value="center"
                                        ...
                                        <?php esc_html_e('Center', 'wceazy'); ?></option>
                                    <option value="right"
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_remove_icon">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Pre Order Close Icon', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('Please select your close icon of Pre Order.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_remove_icon_color">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Close Icon Color', 'wceazy'); ?>
                                <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label
                                        for="wceazy_pre_order_remove_icon_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                                <small><?php esc_html_e('Set your free Pre Order\'s close icon color.', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_remove_icon_size">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Close Icon Size', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_pre_order_text_field" type="number" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_remove_icon_size); ?>">
                                <small><?php esc_html_e('Set your free Pre Order\'s close icon size.', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_enable_progress_bar">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Enable Progress Bar', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch"><input type="checkbox"
                                        <?php echo esc_attr($wceazy_sb_enable_progress_bar == "yes" ? "checked" : ""); ?>><span
                                        class="slider round"></span></label>
                                <small><?php esc_html_e('Show progress bar with free Pre Order.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_progress_margin_top">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e('Progress Bar\'s Top Margin', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_pre_order_text_field" type="number" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_progress_margin_top); ?>">
                                <small><?php esc_html_e('Set your free Pre Order progress margin top.', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_pre_order_field_group wceazy_pre_order_progress_font_size">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e("Progress Bar's Font Size", 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_pre_order_text_field" type="number" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_progress_font_size); ?>">
                                <small><?php esc_html_e('Set your free Pre Order progress font size.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_pre_order_field_group wceazy_pre_order_progress_border_radius">
                            <label
                                for="coupon_generator_coupon_amount"><?php esc_html_e("Progress Bar's Border Radius", 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_pre_order_text_field" type="number" placeholder=""
                                    value="<?php echo esc_attr($wceazy_sb_progress_border_radius); ?>">
                                <small><?php esc_html_e('Set your free Pre Order progress border radius.', 'wceazy'); ?></small>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="wceazy_pre_order_bottom_button_section">
            <button onclick="wceazy_pre_order_save();"><?php esc_html_e('Save Settings', 'wceazy'); ?></button>
        </div>
