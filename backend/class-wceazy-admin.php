    ...
    class WcEazyAdmin
    {
        ...
        public function __construct()
        {
            ...
            if ($this->settings->getModuleStatus("frequently_bought")) {
                include_once WCEAZY_PATH . "modules/frequently_bought/class-module-admin.php";
                include_once WCEAZY_PATH . "modules/frequently_bought/ModuleUtils.php";
                $this->frequently_bought = new WcEazyFrequentlyBoughtAdmin($this);
        ...
        function wceazy_admin_enqueue($page)
        {
            if ($page == "toplevel_page_wceazy-dashboard") {
                ...
                /* ======== Frequently Bought ========== */
                if ($this->settings->getModuleStatus("frequently_bought")) {
                    wp_enqueue_style('wceazy-admin-module-frequently-bought', WCEAZY_CSS_DIR . 'frequently_bought/admin_main.css', array(), WCEAZY_VERSION);
                    wp_enqueue_script('wceazy-admin-module-frequently-bought', WCEAZY_JS_DIR . 'frequently_bought/admin_main.js', array('jquery'), WCEAZY_VERSION);
                }
            }
        }
