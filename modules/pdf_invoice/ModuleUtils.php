                    ...
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="6" cellpadding="4">
                            ...
                            <tr>
                                ...
                                <td width="50%" valign="top" align="right">
                                    <?php if ($wceazy_pi_enable_invoice_number == "yes") { ?>
                                        <p class="wceazy_pi_emulator_invoice_number" style="font-size: 12px;">INVOICE
                                            <b>#
                                                <?php echo $this->generate_invoice_number($order->get_order_number()); ?>
                                            </b>
                                        </p>
                                    <?php } ?>
                                    <?php if ($wceazy_pi_enable_invoice_date == "yes") { ?>
                                        <p class="wceazy_pi_emulator_invoice_date" style="font-size: 10px;">Invoice Date: <b>
                                                <?php echo date('Y/m/d'); ?>
                                            </b></p>
                                    <?php } ?>
                                    <?php if ($wceazy_pi_enable_order_number == "yes") { ?>
                                        <p class="wceazy_pi_emulator_order_number" style="font-size: 10px;">Order No.: <b>
                                                <?php echo $order->get_order_number(); ?>
                                            </b></p>
                                    <?php } ?>
                                    <?php if ($wceazy_pi_enable_order_date == "yes") { ?>
                                        <p class="wceazy_pi_emulator_order_date" style="font-size: 10px;">Order Date:
                                            <b>
                                                <?php echo date('Y/m/d', strtotime($order->get_date_created())); ?>
                                            </b>
                                        </p>
                                    <?php } ?>
                                    <?php if ($wceazy_pi_enable_ssn_id == "yes") { ?>
                                        <p class="wceazy_pi_emulator_ssn_id" style="font-size: 10px;">SSN:
                                            <b>
                                                <?php echo get_post_meta($order->get_id(), 'wceazy_pdf_invoice_ssn_id', true); ?>
                                            </b>
                                        </p>
                                    <?php } ?>
                                    <?php if ($wceazy_pi_enable_vat_id == "yes") { ?>
                                        <p class="wceazy_pi_emulator_vat_id" style="font-size: 10px;">VAT:
                                            <b>
                                                <?php echo get_post_meta($order->get_id(), 'wceazy_pdf_invoice_vat_id', true); ?>
                                            </b>
                                        </p>
                                    <?php } ?>
                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="font-size: 10px;">
                                                        <?php echo $wceazy_pi_sender_name; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                                        <?php echo $wceazy_pi_address_line_one; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                                        <?php echo $wceazy_pi_address_city; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                                        <?php echo WC()->countries->states[$country][$state]; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                                        <?php echo WC()->countries->countries[$country]; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                                        <?php echo $wceazy_pi_postal_code; ?>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="wceazy_pi_emulator_billing_address" width="33.33%" valign="top">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                            <tr>
                                                <td>
                                                    <p style="font-size: 10px;">
                                                        <?php echo $billing_aadress['first_name']; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                                        <?php echo $billing_aadress['address_1']; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                                        <?php echo $billing_aadress['city']; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                    ...
                                    <td class="wceazy_pi_emulator_shipping_address" width="33.33%" valign="top">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                            <tr>
                                                <td>
                                                    <p style="font-size: 10px;">
                                                        <?php echo $shipping_aadress['first_name']; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                                        <?php echo $shipping_aadress['address_1']; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                                        <?php echo $shipping_aadress['city']; ?>
                                                    </p>
                                                    <p style="font-size: 10px;">
                                                    ...
                                                    <p style="font-size: 10px;">
                                                        <?php echo $shipping_aadress['postcode']; ?>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="10">
                            ...
                            if (!empty($order_items)) {
                                foreach ($order_items as $key => $item) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-bottom: 1px solid #cccccc; font-size: 10px;" valign="middle">
                                            <?php echo wc_price($item_data['subtotal']); ?>
                                        </td>
                                    </tr>
                                <?php }
                            } else { ?>
                            ...
                            <tr>
                                ...
                                <td style="border-bottom: 1px solid #cccccc;" valign="middle">
                                    ...
                                    <p style="font-size: 11px;">
                                        <?php echo wc_price($fee_total + $fee_total_tax); ?>
                                    </p>
                                </td>
                            </tr>
                        ...
                        <?php if ($wceazy_pi_enable_footer == "yes") { ?>
                            <table class="wceazy_pi_emulator_footer" width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center">
                                        <?php echo $wceazy_pi_footer_info; ?>
                                    </td>
                                </tr>
                            </table>
                        <?php } ?>
                    ...
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="6" cellpadding="4">
                            <tr>
                                ...
                                <td width="50%" valign="top" align="right">
                                    <?php if ($wceazy_pi_enable_shipping_order_number == "yes") { ?>
                                        <p class="wceazy_pi_emulator_shipping_order_number" style="font-size: 10px;">Order No.:
                                            <b>
                                                <?php echo $order->get_order_number(); ?>
                                            </b>
                                        </p>
                                    <?php } ?>
                                    <?php if ($wceazy_pi_enable_shipping_weight == "yes") { ?>
                                        <p class="wceazy_pi_emulator_shipping_weight" style="font-size: 10px;">Weight:
                                            <b>
                                                <?php echo $total_weight . " " . get_option('woocommerce_weight_unit'); ?>
                                            </b>
                                        </p>
                                    <?php } ?>
                                    <?php if ($wceazy_pi_enable_shipping_date == "yes") { ?>
                                        <p class="wceazy_pi_emulator_shipping_date" style="font-size: 10px;">Shipping Date:
                                            <b>
                                                <?php echo date('Y/m/d') ?>
                                            </b>
                                        </p>
